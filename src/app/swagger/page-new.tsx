...
// Dynamic import SwaggerUI to avoid SSR issues
const SwaggerUIComponent = dynamic(
  () => import('@/components/SwaggerUI'),
  { 
    ssr: false,
    loading: () => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              {swaggerSpec && (
                <button
                  onClick={() => setShowInteractiveUI(!showInteractiveUI)}
                ...
                >
                  {showInteractiveUI ? '✅ Interactive UI' : '🔄 Enable Interactive UI'}
                </button>
              )}
              <a
                href="/dashboard"
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        ...
                        <div className="mt-2 text-sm text-green-800 font-medium">
                          <p>
                            You can now test API endpoints directly from this interface. The &quot;Try it out&quot; feature is enabled.
                          </p>
                        </div>
                      </div>
                    </div>
                  </div>
                  <SwaggerUIComponent spec={swaggerSpec as Record<string, unknown>} />
                </div>
              ) : (
                <div>
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <h3 className="text-sm font-bold text-yellow-900">
                          Simplified API Documentation View
                        </h3>
                        <div className="mt-2 text-sm text-yellow-800 font-medium">
                          <p>
                            Click &quot;Enable Interactive UI&quot; above to load the full Swagger interface for testing endpoints.
                          </p>
                        </div>
                      </div>
                    </div>
